...
public class CreateMultipleOrgWithIndustry 
{
	...
	public void createOrgWithMultilpeOrg(String ORG, String INDUSTRYTYPE) throws InterruptedException, IOException
	{
		//System.out.println(ORG+"  "+INDUSTRYTYPE);
...
/* After u creating the excel file if u  did changes like data addition/deletion will not get impacted. if we want to see  those changes we have to create another excel sheet..*/
